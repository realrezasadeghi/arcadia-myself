...
import type { IClassDiagramRepository, RemoveClassRelationshipLayoutPayload } from "../../ports/class-diagram";
...
export class RemoveClassRelationshipLayoutUseCase
  implements IUseCase<RemoveClassRelationshipLayoutUseCasePayload, RemoveClassRelationshipLayoutUseCaseResponse>
{
  ...
  async execute({
    ...
    try {
      ...
      throw new Error(resolveErrorMessage(error, "Error removing class relationship layout"));
    }
  }
}