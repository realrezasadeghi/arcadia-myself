...
import {
  UpdateClassPropertyDTO,
  type UpdateClassPropertyDTOProps,
} from "../dtos/update-class-property";

export const updateClassProperty = withAuth(
  async (
    payload: UpdateClassPropertyDTOProps,
    { token },
  ): Promise<UpdateClassPropertyUseCaseResponse> => {
