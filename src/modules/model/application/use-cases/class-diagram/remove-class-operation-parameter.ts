...
export class RemoveClassOperationParameterUseCase
  implements
    IUseCase<
      RemoveClassOperationParameterUseCasePayload,
      RemoveClassOperationParameterUseCaseResponse
    >
{
  ...
  async execute({
    ...
    try {
      ...
      throw new Error(
        resolveErrorMessage(error, "Error removing class operation parameter"),
      );
    }
  }
}
