...
export class GetClassRelationshipLayoutByIdUseCase
  implements
    IUseCase<
      GetClassRelationshipLayoutByIdUseCasePayload,
      GetClassRelationshipLayoutByIdUseCaseResponse
    >
{
  ...
  async execute({
    ...
    try {
      ...
      throw new Error(
        resolveErrorMessage(error, "Error getting class relationship layout"),
      );
    }
  }
}
